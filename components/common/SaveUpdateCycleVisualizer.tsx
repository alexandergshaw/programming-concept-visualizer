    ...
    <Box sx={{ my: 4 }}>
      ...
      <Box sx={{ position: 'relative', minHeight: '500px' }}>
        ...
        <Box sx={{
          ...
          background: 'linear-gradient(to bottom, #1e40af, #6366f1)',
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
          ...
          <Box sx={{ 
            ...
            <Box sx={{
              p: 3,
              borderRadius: 4,
              background: step >= 1 ? 'linear-gradient(135deg, #4f46e5 0%, #6366f1 100%)' : 'white',
          ...
          <Box sx={{ 
            ...
            <Box sx={{
              p: 3,
              borderRadius: 4,
              background: step >= 2 ? 'linear-gradient(135deg, #0f766e 0%, #14b8a6 100%)' : 'white',
              border: step >= 2 ? 'none' : '3px dashed #cbd5e1',
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
                <Box sx={{
                  ...
                  height: 40,
                  borderRadius: '50%',
                  background: step >= 2 ? 'rgba(255,255,255,0.2)' : '#f1f5f9',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontWeight: 700,
          ...
          <Box sx={{ 
            ...
            <Box sx={{
              p: 3,
              borderRadius: 4,
              background: step >= 3 ? 'linear-gradient(135deg, #0f766e 0%, #14b8a6 100%)' : 'white',
          ...
          <Box sx={{ 
            ...
            <Box sx={{
              p: 3,
              borderRadius: 4,
              background: step >= 4 ? 'linear-gradient(135deg, #0f766e 0%, #14b8a6 100%)' : 'white',
          ...
          <Box sx={{ 
            ...
            <Box sx={{
              p: 3,
              borderRadius: 4,
              background: step >= 5 ? 'linear-gradient(135deg, #1e40af 0%, #3b82f6 100%)' : 'white',
              border: step >= 5 ? 'none' : '3px dashed #cbd5e1',
              color: step >= 5 ? 'white' : '#64748b',
              transition: 'all 0.5s cubic-bezier(0.68, -0.55, 0.265, 1.55)',
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
                <Box sx={{
                  ...
                  height: 40,
                  borderRadius: '50%',
                  background: step >= 5 ? 'rgba(255,255,255,0.2)' : '#f1f5f9',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontWeight: 700,
          ...
          <Box sx={{ 
            ...
            <Box sx={{
              p: 3,
              borderRadius: 4,
              background: step >= 6 ? 'linear-gradient(135deg, #4f46e5 0%, #6366f1 100%)' : 'white',
              border: step >= 6 ? 'none' : '3px dashed #cbd5e1',
              color: step >= 6 ? 'white' : '#64748b',
              transition: 'all 0.5s cubic-bezier(0.68, -0.55, 0.265, 1.55)',
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
                <Box sx={{
                  ...
                  height: 40,
                  borderRadius: '50%',
                  background: step >= 6 ? 'rgba(255,255,255,0.2)' : '#f1f5f9',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontWeight: 700,
