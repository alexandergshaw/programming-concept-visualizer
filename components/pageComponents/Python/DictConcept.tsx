  ...
  return (
    ...
    >
      <TableOfContents numbered>
        <Section title="Introduction to Dictionaries">
          <div
            style={{
              position: 'relative',
              width: '100%',
          ...
          >
            <iframe
              ...
              src="https://www.canva.com/design/DAGrHl3dUbY/xlN6Nmo_De5WURKRo4avdg/watch?embed"
              allowFullScreen
              allow="fullscreen"
            ></iframe>
          </div>
        ...
        <Section title="Updating, Adding, and Removing Items">
          <div
            style={{
              position: 'relative',
              width: '100%',
          ...
          >
            <iframe
              ...
              src="https://www.canva.com/design/DAGrHl6GQ2Y/Xn9Tdf7uFC1mpGVfZkCLIw/watch?embed"
              allowFullScreen
              allow="fullscreen"
            ></iframe>
          </div>
