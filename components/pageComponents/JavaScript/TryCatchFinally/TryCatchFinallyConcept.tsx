      ...
      <TableOfContents numbered>
        <Section title="Why Error Handling Matters">
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, bgcolor: 'var(--info-bg)', p: 2, borderRadius: 1, mt: 2 }}>
            ...
            <Typography variant="body2">
              <strong style={{ color: 'var(--info)' }}>What&apos;s next:</strong> Let&apos;s start with the try block - where you put code that might fail and see how JavaScript handles it step by step.
            </Typography>
          </Box>
        </Section>
        ...
        <Section title="The Try Block: Executing Risky Code">
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, bgcolor: 'var(--info-bg)', p: 2, borderRadius: 1, mt: 2 }}>
            ...
            <Typography variant="body2">
              <strong style={{ color: 'var(--info)' }}>What&apos;s next:</strong> When the try block fails, the catch block saves the day - let's see how it transforms errors into helpful responses.
            </Typography>
          </Box>
        </Section>
        ...
        <Section title="The Catch Block: When Things Go Wrong">
          <CatchBlockExample />
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, bgcolor: 'var(--info-bg)', p: 2, borderRadius: 1, mt: 2 }}>
            <FontAwesomeIcon icon={faBroom} style={{ fontSize: 20, color: 'var(--info)' }} />
            <Typography variant="body2">
              <strong style={{ color: 'var(--info)' }}>What&apos;s next:</strong> The finally block is your cleanup crew - it always runs, whether your code succeeds or fails. Perfect for essential cleanup tasks.
            </Typography>
          </Box>
        </Section>
        ...
        <Section title="The Finally Block: Always Execute Cleanup">
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, bgcolor: 'var(--info-bg)', p: 2, borderRadius: 1, mt: 2 }}>
            ...
            <Typography variant="body2">
              <strong style={{ color: 'var(--info)' }}>What&apos;s next:</strong> Time to see try, catch, and finally working together in a complete, real-world error handling example.
            </Typography>
          </Box>
        </Section>
        ...
        <Section title="Putting It All Together">
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, bgcolor: 'var(--success-bg)', p: 2, borderRadius: 1, mt: 2 }}>
            ...
            <Typography variant="body2">
              <strong style={{ color: 'var(--success)' }}>Excellent work!</strong> You've mastered error handling and can now write robust JavaScript applications that gracefully handle unexpected situations.
            </Typography>
          </Box>
        </Section>
      </TableOfContents>
